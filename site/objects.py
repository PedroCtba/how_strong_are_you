...
labels = {
    ...
    "missing_data": {"English": "The selected filters have no data, use a less specific filter set.",
                     "Português": "Os filtros selecionados não possuem dados, utilize um conjunto de filtros menos específico."},
